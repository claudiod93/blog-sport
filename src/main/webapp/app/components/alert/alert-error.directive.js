(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('blogsportApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-blogsportApp-error');
                var entityKey = httpResponse.headers('X-blogsportApp-params');
                if (errorHeader) {
